...
from warehouse.envs.constants import hatching_map
...
class Spot():
    ...
    def get_patch(self, unrendered_only = False):
        ...
        self.rendered = True
        return Rectangle( self.spot_corner, 1/2 , 1/2 ,edgecolor='k', facecolor= frequency_cmap(self.package.frequency) if self.is_full else 'none', hatch=
                          hatching_map(self.package.weight) if self.is_full else "")
